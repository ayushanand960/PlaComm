...
const PIPast = () => {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <HeaderBar title="PI Past Activities" backPath="/officer-dashboard/:id/trainingprogram" />

      <h2>Past PI Activities</h2>

      {/* Show all PI activities, no edit, no limit */}
      <ActivityList
        key={refreshKey}
        activityType="PI"
